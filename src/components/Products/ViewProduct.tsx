...
// import { AspectRatio, Avatar, Box, Card, Flex, Text, TextArea, TextField } from '@radix-ui/themes';

// export interface ViewProps {
//   name?: string;
// }

// export default function ViewProduct({ name }: ViewProps) {
...
//         {/* left column */}
//         <Flex direction={'column'} align={'start'} gap={'3'} maxWidth={'300px'} width={'100%'}>
//           {/* Product Name */}
//           <Flex
//             maxWidth={{ xs: '60px', sm: '60px', md: '180px', lg: '300px' }}
//             width={'100%'}
//             direction={'column'}
//             gap={'1'}
//           >
...
//               style={{ textAlign: 'left', padding: '4', maxWidth: '300px', width: '100%' }}
//             >
//               {/* <TextField.Slot /> */}
//             </TextField.Root>
//           </Flex>
//           {/* Product Description */}
//           <Flex
//             maxWidth={{ xs: '60px', sm: '60px', md: '300px', lg: '300px' }}
//             width={'100%'}
//             direction={'column'}
//             gap={'1'}
//           >
...
//           {/* Product SKU and Stock Quantity */}
//           <Flex gap={'2'}>
//             {/* Product SKU */}
//             <Flex
//               maxWidth={{ xs: '60px', sm: '60px', md: '180px', lg: '300px' }}
...
//                 size={'1'}
//                 placeholder="Brand"
//                 defaultValue={product[0].stock_quantity}
//                 style={{
//                   textAlign: 'left',
//                   padding: '4',
//                   maxWidth: '300px',
...
//                 defaultValue={product[0].regular_price}
//                 style={{
//                   textAlign: 'left',
//                   padding: '4',
//                   maxWidth: '300px',
...
//                 defaultValue={product[0].sales_price}
//                 style={{
//                   textAlign: 'left',
//                   padding: '4',
//                   maxWidth: '300px',
...
//               size={'1'}
//               placeholder="Brand"
//               defaultValue={product[0].tag
//                 .map(
//                   (t) =>
//                     //   <Badge radius="full" color="gray" size={'1'}>
//                     t.toLowerCase()
//                   //   </Badge>
//                 )
//                 .join(', ')}
...
//               <Avatar
//                 src={product[0].gallery}
//                 fallback={product[0].name[0]}
//                 radius="large"
//                 size={'9'}
//               />
//             </AspectRatio>
        ...
        {({ setFieldValue, values }) => (
          <Form>
            <Flex justify={'between'} gap={'8'} align={'center'} pl={'1'} pr={'6'} pb={'4'}>
              ...
              {/* RIGHT COLUMN */}
              <Flex direction={'column'} gap={'2'} width={'30%'}>
                <Flex direction={'column'} gap={'1'}>
