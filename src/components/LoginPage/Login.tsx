...
//       gap={'2'}
//       justify={'center'}
//       p={{ lg: '4', sm: '2', xs: '2', md: '2' }}
//       wrap={'wrap'}
//     >
//       <Box position={'relative'} width={'30%'}>
//         <Heading
//           style={{ position: 'absolute', left: 10, height: '80px', maxHeight: '80px', padding: 2 }}
//           size={{ lg: '9', sm: '8', md: '8', xs: '8', initial: '8' }}
//         >
//           <AnimateText
//             texts={['Champions', 'Inventory']}
//           />
//         </Heading>
//         <img
//           width={'95%'}
...
//       <Container
//         px={{ lg: '6', md: '4', sm: '4', xs: '4', initial: '4' }}
//         width={{ xs: '100%', sm: '100%' }}
//       >
...
//             </Link>
//           </Text>
//           <TextField.Root placeholder="Email" style={{ width: '80%' }}>
//             <TextField.Slot />
//           </TextField.Root>
//           <TextField.Root placeholder="Password" style={{ width: '80%' }}>
//             <TextField.Slot />
//           </TextField.Root>

//           <Button variant="classic" size={'3'} style={{ padding: '8px' }} highContrast>
//             Login <CaretRightIcon />
//           </Button>

//           <Flex align={'center'} gap={'4'} width={'40%'}>
//             <Button variant="surface" size={'3'} style={{ width: '60%' }} highContrast>
//               {/* {' '} */}
...
//           <Badge size={'1'}> By Logging in, you agree to our websites terms and conditions.</Badge>
//           <Text size={'2'}>
...
export default function Login() {
  ...
  const action = '/proxy/auth/signin';
  return (
    <Flex
      align="center"
      gap="2"
          ...
          {({ values, handleChange, handleSubmit, handleBlur, touched, errors, isSubmitting }) => (
            <form onSubmit={handleSubmit} style={{ width: '100%' }}>
              ...
              >
                ...
                <Badge size="1">
                  {' '}
                  By logging in, you agree to our website’s terms and conditions.
                </Badge>
